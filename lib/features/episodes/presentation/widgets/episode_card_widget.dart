...
class EpisodeCardWidget extends StatelessWidget {
  ...
  const EpisodeCardWidget({super.key, required this.onTap, required this.name, required this.episode});
                        ...
                        children: [
                          Positioned.fill(
                            child: ClipRRect(
                              ...
                              child: Image(
                                image: AssetImage(AssetsPaths.textBackgroundGreen.path), 
                                fit: BoxFit.cover,
                                ...
                                Expanded(
                                  child: Column(
                                    children: [
                                      ...
                                      Text(episode, style: Theme.of(context).textTheme.labelMedium, maxLines: 1, overflow: TextOverflow.ellipsis),
                                    ],
                                  ),
                                ),
                              ],
